    ...
    super(context, DATABASE_NAME, null, DATABASE_VERSION);}
        ...
        public void onCreate(SQLiteDatabase db) {
            String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                    + KEY_ID + " INTEGER PRIMARY KEY," + KEY_NAME +  " TEXT,"+KEY_DNAME +  " TEXT,"+KEY_DDNAME +  " TEXT"+ ")";
        ...
        public Friends getContact(int id) {
            ...
            Cursor cursor = db.query(TABLE_CONTACTS, new String[]{KEY_ID,
                            KEY_NAME,KEY_DNAME,KEY_DDNAME}, KEY_ID + "=?",
            ...
            if (cursor.moveToFirst()) {
                do {
                  ...
                  contact.setID(Integer.parseInt(cursor.getString(0)));
                    ...
                    contact.setNameD(cursor.getString(2));
                    contact.setNameDD(cursor.getString(3));
