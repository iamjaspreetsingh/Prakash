...
import com.jskgmail.prakash.beaconreference.BeaconTransmitterActivity1;
...
cr.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        CardView comp=findViewById(R.id.find);
        CardView viewc=findViewById(R.id.pub);
        CardView img=findViewById(R.id.hoo);
        CardView emer=findViewById(R.id.pos);
...
sendNotification();
        ...
        else if (id==R.id.findbea)
        {
            startActivity(new Intent(MainActivity.this, MainBeaconActivity.class));
        }
...
void appstarter1()
{
    final TapTargetSequence sequence = new TapTargetSequence(this)
            .targets(
                    ...
                    TapTarget.forView(findViewById(R.id.find), "Tools for you ","For complaint registration, relief funding and searching hospitals") .transparentTarget(true).outerCircleAlpha(0.96f)   ,
...
// notificationId is a unique int for each notification that you must define
        ...
        public static class ApiClientcom {
        ...
        public interface ApiInterfacecom {
            @GET("amountRaised")
            retrofit2.Call<ResponseBody> getall(
        ...
        void totalFundRaised()
        {
            ...
            ApiInterfacecom apiService = ApiClientcom.getClient().create(ApiInterfacecom.class);
//TODO
            Call call = apiService.getall();
            call.enqueue(new Callback() {
                @Override
                    ...
                    if (statusCode == 200) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                else allfund=a[1]+""+a[2]+""+a[3]+""+a[4]+""+a[5]+" wei";

                                Log.e("compbalaneth", String.valueOf(allfund));
